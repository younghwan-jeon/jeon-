...
// Distance sensor
#define _DIST_ALPHA 0.4   //0.4

// Servo range
#define _DUTY_MIN 600    // [20213060] 서보 duty 최소값
#define _DUTY_NEU 1400    // [20213064] 서보 duty 중간값
...
// PID parameters
#define _KP 1   // [20213058]비례이득  0.3   0.3  0.3
#define _KD 75    // 미분이득  2   5  6
#define _KI 0.1     // 적분이득

#define _ITERM_MAX 10// 적분기 와인드업
...
void setup() {
  ...
  error_curr = error_prev = dist_target - dist_raw-70;
...
void loop() {
  ...
  if (event_dist) {
    ...
    dist_raw = ir_distance_filtered(); // [20213055]21
    dist_ema = (1 - _DIST_ALPHA) * dist_ema + _DIST_ALPHA * dist_raw + 20;  //[20213075]
